...
import net.openmob.mobileimsdk.java.event.ChatBaseEventImpl;
import net.openmob.mobileimsdk.java.event.ChatTransDataEventImpl;
import net.openmob.mobileimsdk.java.event.MessageQoSEventImpl;
